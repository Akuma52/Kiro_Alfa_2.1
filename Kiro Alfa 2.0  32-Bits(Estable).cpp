...
case 3:	{
		...
		Tom1:
        if (CJ==Qz){cout<<"             -"<<Luca;++CJ;goto TOM2;}
        if (feof (Preguntas1)){goto GF;}
        else{++Qz;fgets(Luca,100,Preguntas1);goto Tom1;}
...
case 1: {
	...
	scanf("%s",B);
	if (strcmp(B,H)==0){goto A0;}		

    scanf("%s",C);
	if (strcmp(C,H)==0){goto A0;}

	scanf("%s",D);
	if (strcmp(D,H)==0){goto A0;}
	
	scanf("%s",E);
	if (strcmp(E,H)==0){goto A0;}
	
	scanf("%s",F);
	if (strcmp(F,H)==0){goto A0;}
	
	scanf("%s",G);
	if (strcmp(G,H)==0){goto A0;}
	
	scanf("%s",I);
	if (strcmp(I,H)==0){goto A0;}		

    scanf("%s",J);
	if (strcmp(J,H)==0){goto A0;}

	scanf("%s",K);
	if (strcmp(K,H)==0){goto A0;}
	
	scanf("%s",L);
	if (strcmp(L,H)==0){goto A0;}
	
	scanf("%s",M);
	if (strcmp(M,H)==0){goto A0;}
	
	scanf("%s",N);
	if (strcmp(N,H)==0){goto A0;}
	
	scanf("%s",O);
	if (strcmp(O,H)==0){goto A0;}
	
	scanf("%s",Q);
	if (strcmp(Q,H)==0){goto A0;}
	
	
//Guardado de las preguntas del usuario en Preguntas.txt.
A0:
 FILE *Preguntas = fopen("Preguntas.txt", "w");
    fprintf(Preguntas, A);
    if (strcmp(B,".")==1){fprintf(Preguntas, B);}
    if (strcmp(C,".")==1){fprintf(Preguntas, C);}
    if (strcmp(D,".")==1){fprintf(Preguntas, D);}
    if (strcmp(E,".")==1){fprintf(Preguntas, E);}
    if (strcmp(F,".")==1){fprintf(Preguntas, F);}
	if (strcmp(G,".")==1){fprintf(Preguntas, G);}
	if (strcmp(I,".")==1){fprintf(Preguntas, I);}
    if (strcmp(J,".")==1){fprintf(Preguntas, J);}
    if (strcmp(K,".")==1){fprintf(Preguntas, K);}
    if (strcmp(L,".")==1){fprintf(Preguntas, L);}
    if (strcmp(M,".")==1){fprintf(Preguntas, M);}
	if (strcmp(N,".")==1){fprintf(Preguntas, N);}
    if (strcmp(O,".")==1){fprintf(Preguntas, O);}
    if (strcmp(Q,".")==1){fprintf(Preguntas, Q);}
	fclose(Preguntas);	
...
if (strcmp(A,"ADMIN")==0){cout<<"Introdusca su clave: ";}
else {goto D100;}
D01:
	scanf("%s",ADMIN);
...
// Eto Saca X1 Y X2    
 ...
 XR = sqrt(PrP);
	...
	goto PP;
	//Juani del futuro, Azo pota madre cuanto tiempo llevas mejorando esto 28/10/2017, Pos demaciado 20/11/2017, Novatos 12/12/2017
}
break;}
...
case 2 : {
	...
	case 6 : {
		...
		double Fibo = 0, Fi1 = 0, Fi2 = 1,Fi3 = 0, Sopota = 0;
...
//En el caso de que no se encuentre la pregunta se pasa a guardar y darle una respuesta.
	...
	cout<<"No puedo reconocer tu pregunta ,¿esta bien escrita?\n 1)Si\n 2)No \n";cin>>D1;
	switch (D1){
...
A100:
	POlvidalo = fopen("Olvidalo.txt","w");
    fprintf(POlvidalo, A);
    if (strcmp(B,".")==1){fprintf(POlvidalo, B);}
    if (strcmp(C,".")==1){fprintf(POlvidalo, C);}
    if (strcmp(D,".")==1){fprintf(POlvidalo, D);}
    if (strcmp(E,".")==1){fprintf(POlvidalo, E);}
    if (strcmp(F,".")==1){fprintf(POlvidalo, F);}
	if (strcmp(G,".")==1){fprintf(POlvidalo, G);}
	if (strcmp(I,".")==1){fprintf(POlvidalo, I);}
    if (strcmp(J,".")==1){fprintf(POlvidalo, J);}
    if (strcmp(K,".")==1){fprintf(POlvidalo, K);}
    if (strcmp(L,".")==1){fprintf(POlvidalo, L);}
    if (strcmp(M,".")==1){fprintf(POlvidalo, M);}
	if (strcmp(N,".")==1){fprintf(POlvidalo, N);}
    if (strcmp(O,".")==1){fprintf(POlvidalo, O);}
    if (strcmp(Q,".")==1){fprintf(POlvidalo, Q);}
    fclose(POlvidalo);
    
    POlvidalo1 = fopen("Olvidalo1.txt","w");
    fprintf(POlvidalo1, A);fprintf(POlvidalo1, " ");
    if (strcmp(B,".")==1){fprintf(POlvidalo1, B);fprintf(POlvidalo1," ");}
    if (strcmp(C,".")==1){fprintf(POlvidalo1, C);fprintf(POlvidalo1," ");}
    if (strcmp(D,".")==1){fprintf(POlvidalo1, D);fprintf(POlvidalo1," ");}
    if (strcmp(E,".")==1){fprintf(POlvidalo1, E);fprintf(POlvidalo1," ");}
    if (strcmp(F,".")==1){fprintf(POlvidalo1, F);fprintf(POlvidalo1," ");}
	if (strcmp(G,".")==1){fprintf(POlvidalo1, G);fprintf(POlvidalo1," ");}
	if (strcmp(I,".")==1){fprintf(POlvidalo1, I);fprintf(POlvidalo1," ");}
    if (strcmp(J,".")==1){fprintf(POlvidalo1, J);fprintf(POlvidalo1," ");}
    if (strcmp(K,".")==1){fprintf(POlvidalo1, K);fprintf(POlvidalo1," ");}
    if (strcmp(L,".")==1){fprintf(POlvidalo1, L);fprintf(POlvidalo1," ");}
    if (strcmp(M,".")==1){fprintf(POlvidalo1, M);fprintf(POlvidalo1," ");}
	if (strcmp(N,".")==1){fprintf(POlvidalo1, N);fprintf(POlvidalo1," ");}
	if (strcmp(O,".")==1){fprintf(POlvidalo1, O);fprintf(POlvidalo1," ");}
    if (strcmp(Q,".")==1){fprintf(POlvidalo1, Q);fprintf(POlvidalo1," ");}
    fclose (POlvidalo1);
    system ("cls");
    goto pregunta2;
